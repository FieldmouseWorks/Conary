...
revision: 86
summary: Compact workspace orientation index routing feature ownership, CLI diagnostics, package results, changeset history, and progress through agent-context
---
...
| `cli-ui` | Durable diagnostics, grouped package results, changeset history frames, and transient progress coordination | `docs/operations/daily-driver-ux-matrix.md` |
