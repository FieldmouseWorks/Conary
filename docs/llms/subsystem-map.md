...
revision: 87
summary: Compact workspace orientation index routing feature ownership, CLI diagnostics, package details and results, history, and progress through agent-context
---
...
| `cli-ui` | Durable diagnostics, installed package details, grouped results, history frames, and transient progress coordination | `docs/operations/daily-driver-ux-matrix.md` |
