...
// decode indexed file handles, and create whiteouts. This profile is guest-only.
pub(crate) const EXPERIMENT_CAPABILITIES: [&str; 4] =
    ["SYS_ADMIN", "DAC_OVERRIDE", "DAC_READ_SEARCH", "MKNOD"];
pub(crate) const EXPERIMENT_CAPABILITY_MASK: u64 = (1 << 21) | (1 << 1) | (1 << 2) | (1 << 27);
