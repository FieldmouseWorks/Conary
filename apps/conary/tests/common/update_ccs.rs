...
//! Signed eopkg update artifacts shared by collection and CLI preview tests.
...
pub fn repository(conn: &rusqlite::Connection) -> (i64, SigningKeyPair) {
    ...
    repo.source_profile = Some("solus".into());
...
pub fn candidate(
    ...
    manifest.package.version_scheme = conary_core::repository::versioning::VersionScheme::Eopkg;
    ...
    manifest.native_lifecycle = Some(NativeLifecycleBundle {
        ...
        source_format: SourceFormat::Eopkg,
        source_family: "solus".into(),
        source_profile: Some("solus".into()),
        source_release: None,
    ...
    package.source_profile = Some("solus".into());
